...
INSERT INTO users (email, password, role_id, barangay_id, first_name, last_name, gender, email_verified_at, is_active) VALUES
    ...
    ('captain.bma@barangay.com', '$2y$10$YavXAnllLC3VCF8R0eVxXeWu/.mawVifHel6BYiU2H5oxCz8nfMIm', 3, 1, 'Ricardo', 'Morales', 'Male', NOW(), TRUE);
...
CREATE INDEX idx_users_esignature ON users(esignature_path);INSERT INTO schedule_proposals (blotter_case_id, proposed_by_user_id, proposed_date, proposed_time) VALUES     (1, 3, '2025-06-02', '10:00:00'),     (4, 3, '2025-06-05', '09:00:00')
