...
ALTER TABLE document_requests
ADD COLUMN previous_permit_docai_used BOOLEAN DEFAULT FALSE AFTER business_type;

-- Add is_renewal column to document_requests if it doesn't exist
ALTER TABLE document_requests
ADD COLUMN is_renewal BOOLEAN DEFAULT FALSE AFTER previous_permit_docai_used;
