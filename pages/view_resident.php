    ...
    <div class="container mx-auto p-4 max-w-5xl">
        ...
        <div class="section-card">
            ...
            <?php if ($health_info): ?>
                    ...
                    <div class="data-card hover:bg-white mb-4">
                        <div class="flex items-start">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="text-gray-700"><?= htmlspecialchars($health_info['health_condition']) ?></div>
                            </div>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <?php if (!empty($health_info['has_maintenance'])): ?>
                        <div class="data-card hover:bg-white">
                            <div class="flex items-start">
                                <div class="mr-3 mt-1 text-blue-500">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <div class="flex-1">
                                    <h4 class="font-medium text-gray-800 mb-2">Has Maintenance Medication</h4>
                                    <?php if (!empty($health_info['maintenance_details'])): ?>
                                        <p class="text-sm text-gray-600 mt-2"><?= htmlspecialchars($health_info['maintenance_details']) ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <?php if (!empty($health_info['high_cost_medicine'])): ?>
                        <div class="data-card hover:bg-white">
                            <div class="flex items-start">
                                <div class="mr-3 mt-1 text-red-500">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 2a8 8 0 100 16 8 8 0 000-16zm1 11a1 1 0 11-2 0 1 1 0 012 0zm0-3a1 1 0 10-2 0v1a1 1 0 102 0V10z" clip-rule="evenodd"></path>
                                    </svg>
                                </div>
                                <div class="flex-1">
                                    <h4 class="font-medium text-gray-800 mb-2">High Cost Medicines</h4>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
                        
                        <?php if (!empty($health_info['lack_medical_professionals'])): ?>
                        <div class="data-card hover:bg-white">
                            <div class="flex items-start">
                                <div class="mr-3 mt-1 text-red-500">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <?php if (!empty($health_info['lack_sanitation'])): ?>
                        <div class="data-card hover:bg-white">
                            <div class="flex items-start">
                                <div class="mr-3 mt-1 text-red-500">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <div class="flex-1">
                                    <h4 class="font-medium text-gray-800 mb-2">Lack Sanitation Access</h4>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
                        
                        <?php if (!empty($health_info['lack_health_insurance'])): ?>
                        <div class="data-card hover:bg-white">
                            <div class="flex items-start">
                                <div class="mr-3 mt-1 text-red-500">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <?php if (!empty($health_info['lack_medical_facilities'])): ?>
                        <div class="data-card hover:bg-white">
                            <div class="flex items-start">
                                <div class="mr-3 mt-1 text-red-500">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <div class="flex-1">
                                    <h4 class="font-medium text-gray-800 mb-2">Lack Medical Facilities</h4>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
                    ...
                    <?php if (!empty($health_info['other_health_concerns'])): ?>
                        <div class="data-card hover:bg-white mt-4">
                            <div class="flex items-start">
                                <div class="mr-3 mt-1 text-yellow-500">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
